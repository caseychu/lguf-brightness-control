...
static libusb_device_handle* get_lg_ultrafine() {
	...
	for (int i = 0; i < count; i++) {
		...
		DBOUT(descriptor.idVendor << " " << descriptor.idProduct << "\r\n")
...
libusb_device_handle* init_lg_ultrafine() {
	...
	if (handle == NULL)
		throw std::runtime_error("Failed to find LG Ultrafine");
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE, PWSTR pCmdLine, int nCmdShow)
{
	...
	const wchar_t CLASS_NAME[] = L"Brightness Controller";
